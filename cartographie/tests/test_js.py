...
class TestsJSPanneauIdentifier(BaseCartographieTest):
    ...
    def test_offline_core(self):
        self._lancer(DOSSIER_JS / 'test_offline_core.js')

    def test_gps_core(self):
        self._lancer(DOSSIER_JS / 'test_gps.js')

    def test_analyse_spatiale_core(self):
        self._lancer(DOSSIER_JS / 'test_analyse_spatiale.js')
